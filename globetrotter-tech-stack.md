# GlobeTrotter — 24hr Hackathon Architecture & Tech Stack
...
## 3. Core Data Model (Postgres, via Prisma)
...
## 6. Talking Points for Judges (technical depth angle)
...
## 7. Cuts if you're behind schedule (in priority order to drop)
